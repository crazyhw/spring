<template>
  <div>
    ...
    <el-table :data="tableData">
      <el-table-column  label="商家名" width="140">
        <template slot-scope="scope">
          <span style="margin-left: 10px">{{ scope.row.name }}</span>
        </template>
      </el-table-column>
      <el-table-column  label="商家好评分" width="140">
        <template slot-scope="scope">
        ...
        <template slot-scope="scope">
          ...
          <el-dialog title="添加货架" :visible.sync="dialogFormVisible">
            <el-form :model="Form">
              ...
              <el-form-item label="商家好评分" :label-width="formLabelWidth">
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        ...
        this.$axios
          .delete('merchant/deleteMerchant/' + expenditureId)
          .then(res => {
            console.log(res);
