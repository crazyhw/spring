...
<div class="container-fluid">
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
            <h2 class="sub-header">商品评价</h2>
            <div class="row">
                <div class="col-lg-2">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="请输入商品名" id="write">
                        <span class="input-group-btn">
                            <button class="btn btn-default" type="button" onclick="searchTrade()">查询</button>
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="myModalBody">
                            ...
                            <div class="input-group my-center">
                                ...
                                <input type="text" class="form-control" placeholder="请输入商品评价" id="marks">
                            </div>
                            <br/>
                        </div>
                        <div class="modal-footer">
                            <button id="modal-submit" type="button" class="btn btn-primary" onclick="addTrade()">确认</button>
...
<script type="application/javascript">
    ...
    function getdata() {
        ...
        $.ajax({
            url:"http://localhost:8080/seahorse/trade/all",
            type:"get",
            dataType:"JSON",
            async:false,
    ...
    $(document).on("click", ".delete", function () {
        ...
        if(confirm("是否删除？")){
            $.ajax({
                type:"post",
                url:"http://localhost:8080/seahorse/trade/deleteTrade",
                data:id ,
                dataType:"JSON",
                async:false,
    ...
    function addTrade(){
        ...
        trade.name=$('#name').val();
        trade.num=$('#num').val();
        trade.marks=$('#marks').val();
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/trade/addTrade",
    ...
    $(document).on("click", ".update", function () {
        ...
        $("#modal-submit").attr("onclick", "updateTrade("+id+")");
    });
    function clearModal() {
    ...
    function updateTrade(id) {
        ...
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/trade/updateTrade",
            data: JSON.stringify(trade),
            dataType:"JSON",
            async:false,
            contentType:"application/json;charset=utf-8",
            success:function (data) {
                if(data==true) {
                    $("#myModal").modal('hide');
                    $("#modal-submit").attr("onclick", "addTrade()");
                    clearModal();
                    getdata();
                }else{
                    alert("修改失败！");
    ...
    function searchTrade() {
        ...
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/trade/searchTrade",
            data:name ,
            dataType:"JSON",
            async:false,
            contentType:"application/json;charset=utf-8",
