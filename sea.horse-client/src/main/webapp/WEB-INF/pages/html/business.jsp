...
<div class="container-fluid">
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
            <h2 class="sub-header">监督联盟信息</h2>
            <div class="row">
                <div class="col-lg-2">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="请输入监督联盟名称" id="write">
                        <span class="input-group-btn">
                            <button class="btn btn-default" type="button" onclick="searchBusiness()">查询</button>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog" style="width:300px">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">添加监督联盟</h4>
                        </div>
                        <div class="modal-body" id="myModalBody">
                            <div class="input-group my-center">
                                <span class="input-group-addon">联盟编号</span>
                                <input type="text" class="form-control" placeholder="请输入联盟编号" id="num">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">联盟名称</span>
                                <input type="text" class="form-control" placeholder="请输入联盟名称" id="name">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">联盟管理区域</span>
                                <input type="text" class="form-control" placeholder="请输入联盟管理区域" id="market">
                            </div>
                            <br/>
                        </div>
                        <div class="modal-footer">
                            <button id="modal-submit" type="button" class="btn btn-primary" onclick="addBusiness()">确认</button>
...
<script type="application/javascript">
    ...
    function getdata() {
        ...
        $.ajax({
            url:"http://localhost:8080/seahorse/business/all",
            type:"get",
            dataType:"JSON",
            async:false,
    ...
    $(document).on("click", ".delete", function () {
        ...
        if(confirm("是否删除？")){
            $.ajax({
                type:"post",
                url:"http://localhost:8080/seahorse/business/deleteBusiness",
                data:id ,
                dataType:"JSON",
                async:false,
    ...
    function addBusiness(){
        var business = {};
        business.num=$('#num').val();
        business.name=$('#name').val();
        business.market=$('#market').val();
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/business/addBusiness",
    ...
    $(document).on("click", ".update", function () {
        ...
        $("#modal-submit").attr("onclick", "updateBusiness("+id+")");
    });
    function clearModal() {
    ...
    function updateBusiness(id) {
        ...
        business.name=$('#name').val();
        business.market=$('#market').val();
        alert(business.num+" "+business.name+" "+business.market);
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/business/updateBusiness",
            data: JSON.stringify(business),
            dataType:"JSON",
            async:false,
            contentType:"application/json;charset=utf-8",
    ...
    function searchBusiness() {
        ...
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/business/searchBusiness",
            data:num ,
            dataType:"JSON",
            async:false,
            contentType:"application/json;charset=utf-8",
