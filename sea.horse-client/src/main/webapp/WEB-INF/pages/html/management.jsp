    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
            ...
            <ul class="nav nav-sidebar">
                <!--<li class="active"><a href="#">仓储信息/a></li>-->
                <li><a href="management/man">仓储管理</a></li>
            </ul>
            <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-md-10 main">
            <h2 class="sub-header">仓库信息</h2>
            <div class="row">
                <div class="col-lg-2">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="请输入仓库名称" id="write">
                        <span class="input-group-btn">
                            <button class="btn btn-default" type="button" onclick="searchManagement()">查询</button>
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="myModalBody">
                            <div class="input-group my-center">
                                ...
                                <input type="text" class="form-control" placeholder="请输入仓库名称" id="name">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">仓库编号</span>
                                <input type="text" class="form-control" placeholder="请输入仓库编号" id="num">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">仓库内存</span>
                                <input type="text" class="form-control" placeholder="请输入货物种类" id="number">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">仓库地址</span>
                                <input type="text" class="form-control" placeholder="请输入仓库地址" id="address">
                            </div>
                            <br/>
                            <br/>
                        </div>
                        <div class="modal-footer">
                            <button id="modal-submit" type="button" class="btn btn-primary" onclick="addManagement()">确认</button>
...
<script type="application/javascript">
    ...
    function getdata() {
        ...
        $.ajax({
            url:"http://localhost:8080/seahorse/management/all",
            type:"get",
            dataType:"JSON",
            async:false,
    ...
    $(document).on("click", ".delete", function () {
        ...
        if(confirm("是否删除？")){
            $.ajax({
                type:"post",
                url:"http://localhost:8080/seahorse/management/deleteManagement",
                data:id ,
                dataType:"JSON",
                async:false,
    ...
    function addManagement(){
        var management = {};
        var shelve= {};
        management.shelves=shelve;
        management.name=$('#name').val();
        management.num=$('#num').val();
        management.number=$('#number').val();
        management.address=$('#address').val();
        alert(management.name+" "+management.num+" "+management.address);
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/management/addManagement",
    ...
    $(document).on("click", ".update", function () {
        ...
        $("#modal-submit").attr("onclick", "updateManagement("+id+")");
    });
    function clearModal() {
    ...
    function updateManagement(id) {
        ...
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/management/updateManagement",
            data: JSON.stringify(management),
            dataType:"JSON",
            async:false,
            contentType:"application/json;charset=utf-8",
            success:function (data) {
                if(data==true) {
                    $("#myModal").modal('hide');
                    getdata();
                    $("#modal-submit").attr("onclick", "addManagement()");
                    clearModal();
                }else{
                    alert("修改失败！");
                }
    ...
    function searchManagement() {
        ...
        $.ajax({
            type:"post",
            url:"http://localhost:8080/seahorse/management/searchManagement",
            data:name ,
            dataType:"JSON",
            async:false,
            contentType:"application/json;charset=utf-8",
