...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${pageContext.request.contextPath}/seahorse/">海马海马</a>
        </div>
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li><a href="${pageContext.request.contextPath}/seahorse/student/stu" target="_ext">所有学生信息</a></li>
            </ul>
            <ul class="nav nav-sidebar">
                <li><a href="">商家管理</a></li>
                <li><a href="">货物</a></li>
            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="请输入学号" id="write">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="myModalBody">
                            <div class="input-group my-center">
                                ...
                                <input type="text" class="form-control" placeholder="请输入学生学号" id="num">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">姓名</span>
                                <input type="text" class="form-control" placeholder="请输入学生姓名" id="name">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">性别</span>
                                <input type="text" class="form-control" placeholder="请输入学生性别" id="sex">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">专业</span>
                                <input type="text" class="form-control" placeholder="请输入学生专业" id="major">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">年级</span>
                                <input type="text" class="form-control" placeholder="请输入学生年级" id="grade">
                            </div>
                            <br/>
                            <div class="input-group my-center">
                                <span class="input-group-addon">班级</span>
                                <input type="text" class="form-control" placeholder="请输入学生班级" id="cla">
                            </div>
                            <br/>
                        </div>
